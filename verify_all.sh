...
YARNS=("1.21.4+build.8" "1.21.5+build.1" "1.21.6+build.1" "1.21.7+build.8" "1.21.8+build.1" "1.21.9+build.1" "1.21.10+build.3" "1.21.11+build.5")
FABRICS=("0.110.0+1.21.4" "0.127.0+1.21.5" "0.128.0+1.21.6" "0.129.0+1.21.7" "0.131.0+1.21.8" "0.134.1+1.21.9" "0.138.4+1.21.10" "0.141.4+1.21.11")
...
echo -e "${GREEN}   Minecraft 1.21.4 to 1.21.11 are fully        ${NC}"
